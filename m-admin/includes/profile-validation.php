...
&& valid_url($_POST['website']))
{
	...
	$update = "UPDATE m_users SET user_firstname = '$firstname', user_lastname = '$lastname', user_username = '$username', user_email = '$email', user_website = '$website', reg_time = '$reg_time' WHERE user_id='$id'";
	if(!mysqli_query($con, $update)) {
	  echo 'Something has wrong in query';
	}else {
		$_SESSION['name'] = $firstname.' '.$lastname;
		header("location: edit-profile.php?success=Update+successful&cid=".$_GET['cid']);
	}
}
}
